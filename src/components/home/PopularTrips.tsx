...
function TripCard({
    ...
    return (
        ...
        >
            <Card className="relative h-full overflow-hidden rounded-[26px] border-border/70 bg-card/95 py-0 shadow-sm transition-all duration-300 group-hover:-translate-y-1 group-hover:border-primary/30 group-hover:shadow-xl group-focus-visible:border-primary/40 group-focus-visible:shadow-xl">
                <div className="absolute inset-x-5 top-0 h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent" />

                <CardHeader className="relative min-h-40 overflow-hidden rounded-t-[26px] border-b border-border/50 bg-[linear-gradient(135deg,hsl(var(--primary)/0.18),hsl(var(--background))_50%,rgba(251,191,36,0.18))] px-4 py-4 sm:min-h-44 sm:px-5 sm:py-5">
                    <div className="absolute right-3 top-3 text-6xl font-black leading-none text-primary/10 transition-transform duration-300 group-hover:scale-110 group-hover:text-primary/15 sm:right-4 sm:top-4 sm:text-[4.5rem]">
                        {rank}
                    </div>
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-between gap-4">
                        <div className="flex flex-wrap items-center gap-2">
                            <Badge className="rounded-full bg-primary px-3 py-1 text-[11px] font-bold uppercase tracking-[0.2em] text-primary-foreground shadow-sm">
                                {popularTitle}
                            </Badge>
                            <Badge
                                variant="secondary"
                                className="rounded-full border border-white/60 bg-white/75 px-3 py-1 text-[11px] font-semibold text-foreground shadow-sm backdrop-blur"
                            >
                                Top #{rank}
                            </Badge>
                        </div>
                ...
                <CardFooter className="mt-auto flex items-center justify-between border-t border-border/50 px-4 py-3 sm:px-5 sm:py-3.5">
                    <div className="flex items-center gap-2 text-xs text-muted-foreground sm:gap-3">
                        <Badge
                            variant="outline"
                            className="rounded-full border-red-200 bg-red-50 px-3 py-1 text-red-600"
                        >
                        ...
                        <Badge
                            variant="outline"
                            className="rounded-full border-border/70 bg-background px-3 py-1 text-foreground/75"
                        >
                    ...
                    <span className="text-xs font-semibold uppercase tracking-[0.18em] text-primary/70 transition-transform duration-300 group-hover:translate-x-1">
                        Top #{rank}
                    </span>
                </CardFooter>
            </Card>
...
export default function PopularTrips() {
    ...
    return (
        <section className="w-full">
            <div className="relative overflow-hidden rounded-[32px] border border-border/60 bg-[linear-gradient(180deg,hsl(var(--background)),hsl(var(--muted)/0.4))] px-4 py-6 shadow-sm sm:px-6 sm:py-8 lg:px-8">
                ...
                <div className="relative flex flex-col gap-6 sm:gap-8">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div className="max-w-2xl space-y-3">
                            <Badge
                                variant="outline"
                                className="w-fit rounded-full border-primary/20 bg-primary/5 px-3 py-1 text-xs font-bold uppercase tracking-[0.22em] text-primary"
                            >
                                {t('home.popularTitle')}
                            </Badge>
